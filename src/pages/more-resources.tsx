    ...
    return (
        <Layout>
            ...
            <div className={styles.hero}>
                ...
                <p>
                    Some of the best websites for finding social groups in
                    Bristol.
                </p>
                <h2>Meetup.com</h2>
                <p>
                    One of the most active social group sites, Meetup hosts a
                    variety of established and fledgling groups, as well as
                    virtual events.
                </p>
                <p>
                    <Link
                ...
                <p>
                    ...
                    around the UK. With some searching you&apos;ll find
                    community groups that have been using the platform to meet
                    regularly.
                </p>
                <p>
                    <Link
                ...
                <h2>Headfirst</h2>
                <p>
                    A Bristol specific website dedicated to listing a wide
                    variety of arts, music and club events from all over the
                    area. Often better for one-off events, with some regular
                    social groups listed in the &apos;Arts&apos; category.
                </p>
                <p>
                    <Link
                        url="https://www.headfirstbristol.co.uk/#home"
                        external
                    >
                ...
                <p>
                    ...
                    elsewhere, it&apos;s likely worth searching or asking in
                    r/Bristol. See the forum sidebar for more websites that list
                    local events.
                </p>
                <p>
