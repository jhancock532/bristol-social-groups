...
/* To use, navigate to the root of the project and run
...
const files = [
    { newPath: `${camelComponentName}.module.scss`, content: SCSS_TEMPLATE },
    {
...
try {
    ...
    files.forEach(({ newPath }) => {
        ...
        fs.mkdirSync(path.join(componentPath, dirPath), { recursive: true });
    });
